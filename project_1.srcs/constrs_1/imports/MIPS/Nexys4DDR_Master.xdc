...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { inc }];
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets { dec }];
...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { mem }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
...
#set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { step }]; #IO_L12P_T1_MRCC_14 Sch=btnl
#set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L10N_T1_D15_14 Sch=btnr
